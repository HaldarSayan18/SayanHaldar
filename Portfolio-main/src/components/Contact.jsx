...
const Contact = ({ islightmode }) => {
  ...
  const handleSubmit = (e) => {
    ...
    fetch("https://getform.io/f/bpjpnnxb", {
      method: "POST",
      body: data,
    })
      .then(() => {
    ...
    >
      ...
      <style>{`
        ...
        textarea:-webkit-autofill {
          ...
          -webkit-box-shadow: 0 0 0px 1000px ${islightmode ? "#fff" : "#171717"
        } inset !important;
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
          ...
          <form
            ...
            className={`w-full max-w-xl mx-auto flex flex-col gap-6 transition-colors ease-linear duration-700 p-6 rounded-2xl shadow-xl border ${islightmode
          ...
          >
            {/* Thank you message */}
            <div
              className={`text-center font-semibold text-xl transition-opacity duration-700 ${submitted
            ...
            {!submitted && (
              <>
                <input
                  ...
                  required
                  className={`p-3 rounded-md outline-none border transition-colors ${islightmode
                ...
                <textarea
                  ...
                  required
                  className={`p-3 rounded-md outline-none border resize-none transition-colors ${islightmode
                    ? "bg-white text-black border-gray-300"
                    : "bg-neutral-900 text-white border-gray-600"
                    }`}
                ></textarea>
          ...
          <div className="flex flex-col gap-6 text-base w-full max-w-md mx-auto">
            <div className="flex items-center gap-4 p-4 rounded-xl shadow-md bg-gradient-to-r from-white/10 to-white/5 border border-white/10 backdrop-blur-md w-full">
              ...
              <div>
                ...
                <p className="text-base">sayanhaldar05@gmail.com</p>
              </div>
            </div>
            <div className="flex items-center gap-4 p-4 rounded-xl shadow-md bg-gradient-to-r from-white/10 to-white/5 border border-white/10 backdrop-blur-md w-full">
              ...
              <div>
                ...
                <p className="text-base">+91-9073127884</p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-6 mt-6 text-3xl justify-center">
              <a
                href="https://www.linkedin.com/in/sayan-haldar-a2ba5a183/"
                target="_blank"
              ...
              <a
                href="https://github.com/HaldarSayan18"
                target="_blank"
                rel="noopener noreferrer"
